...
public class Badminton extends AbstractClass{
   Connection cn = db.mycon();
    ...
    public Badminton(int harga, int lama, String lapangan, String status, String kasir, String penyewa, String masuk, String keluar,String keterangan, java.sql.Date tglMain, java.sql.Date tglBooking){
        this.harga = harga;
        this.lama = lama;
   ...
   @Override
    public void simpan( int DP,int total, int sisa){
        ...
        try{
            ...
            rs = st.executeQuery("SELECT tgl_main, masuk, keluar, lapangan FROM tb_booking_badminton WHERE tgl_main = '" + this.tglMain +"' and masuk ='" + this.masuk +"' and keluar ='"+ this.keluar+"' and lapangan='"+this.lapangan+"'");
            if(rs.next()){
            ...
            st.executeUpdate("insert into tb_booking_badminton values('" +this.kdBooking+"', '"+ this.tglBooking+ "', '" +this.tglMain + "', '"+ 
   ...
   @Override
    public void update(int DP, int total, int sisa,String kdBooking){
        ...
        try{
            st = cn.createStatement();
            st.executeUpdate("update tb_booking_badminton set tgl_booking = '" + this.tglBooking+ "',  tgl_main ='" + this.tglMain+ "', kasir = '"+ this.kasir+
    ...
    public void delete(String kdBooking) throws SQLException{
        st = cn.createStatement();
        st.executeUpdate("DELETE FROM tb_booking_badminton WHERE kd_booking='" + kdBooking + "'");
    }
